...
OUT_PATH = Path("results/coco500_val100_seed123_predictions_noisy60_fixed_ablation.json")

CHECKPOINTS = {
    "base": None,
    "learned_noisy60": Path("results/coco500_noisy60_10ep_seed123_learned_learned_blip.pt"),
    "alignonly_fixed_noisy60": Path("results/coco500_noisy60_alignonly_fixed_10ep_seed123_learned_blip.pt"),
    "fluencyonly_fixed_noisy60": Path("results/coco500_noisy60_fluencyonly_fixed_10ep_seed123_learned_blip.pt"),
    "agreementonly_fixed_noisy60": Path("results/coco500_noisy60_agreementonly_fixed_10ep_seed123_learned_blip.pt"),
