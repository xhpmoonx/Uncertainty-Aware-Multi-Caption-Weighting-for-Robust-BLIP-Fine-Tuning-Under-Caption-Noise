...
PRED_PATH = Path("results/coco500_val100_seed123_predictions_noisy40.json")
OUT_JSON = Path("results/coco500_val100_seed123_bleu_noisy40.json")
OUT_MD = Path("results/coco500_val100_seed123_bleu_noisy40.md")

with open(PRED_PATH, "r") as f:
    data = json.load(f)

models = ["base", "learned_noisy40", "uniform_noisy40", "top1_noisy40"]
...
lines = ["# COCO Val-100 BLEU Results (Noisy40 Training)", ""]
