...
OUT_JSON = Path("results/coco500_val100_seed123_bleu_noisy60_fixed_ablation.json")
OUT_MD = Path("results/coco500_val100_seed123_bleu_noisy60_fixed_ablation.md")
...
models = [
    "base",
    "learned_noisy60",
    "alignonly_fixed_noisy60",
    "fluencyonly_fixed_noisy60",
    "agreementonly_fixed_noisy60",
    "uniform_noisy60",
    "top1_noisy60",
]
...
lines = ["# Noisy60 Fixed Ablation BLEU Results", ""]
