...
OUT_JSON = Path("results/coco500_val100_seed123_bleu_noisy60.json")
OUT_MD = Path("results/coco500_val100_seed123_bleu_noisy60.md")

with open(PRED_PATH, "r") as f:
    data = json.load(f)

models = ["base", "learned_noisy60", "uniform_noisy60", "top1_noisy60"]
...
lines = ["# COCO Val-100 BLEU Results (Noisy60 Training)", ""]
